...
実はこれで正しくて、位置0からの行動は左が最適なんですよ。もし右に進んでゴールに向かう場合は位置6（左も右も「H」で危険）を通ることになって、位置6から下に移動しようとすると、下か右か左にそれぞれ1/3の確率で進むので2/3の確率で穴に落ちちゃう。だから、右には進みたくない。でも、下に進むと1/3の確率で行きたくない右に進んじゃう。だから敢えて左にして、左か上か下に進むことにして、左や上の場合には進めないので2/3の確率で位置の変更はなし、そして1/3の確率で安全に下に進めるので嬉しいというわけ。ほら、位置0での行動は左が最適で、これを勝手に学んだQ学習は凄いでしょ？
...
やはり過学習していたみたいで（本当に、途中で学習を打ち切ればよかった）、かなりマシでした。でも、どんな盤面でも華麗なドライビングを決める汎化性能は得ていないみたい。まだまだ先は長いですな。
