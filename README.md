...
世の中には、たとえば所有するオートバイの台数みたいに1台、2台と数えられるもの（私は少々頭が悪いので5台持っています。バイクはバカにしか乗れません）と、たとえば体重みたいにどこまでも細かくしていけるもの（コロナ太りで79.9kgになりました。仮に体重計が80kgだと表示しても79.999999...kgを丸めて80kgと表示したのだと信じるつもりでいます）があり、前者を離散量、後者を連続量と呼びます。
